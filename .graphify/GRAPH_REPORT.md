...
## Corpus Check
- 19 files · ~9,717 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 117 nodes · 239 edges · 13 communities detected
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output
- Edge kinds: references: 110 · specifies: 56 · contains: 42 · verifies: 31

## God Nodes (most connected - your core abstractions)
1. `Software requirements specification` - 40 edges
2. `Use cases and acceptance journeys` - 38 edges
3. `Verification and traceability` - 28 edges
4. `Architecture decisions and stack` - 22 edges
5. `EasyLedger documentation home` - 19 edges
6. `Delivery plan and risk register` - 17 edges
7. `Security and operations plan` - 14 edges
8. `Agent workflow and API contracts` - 12 edges
9. `Implementation handoff and runbook` - 12 edges
10. `Knowledge system maintenance` - 11 edges
...
### Community 0 - "Delivery plan and risk register"
Cohesion: 0.15
Nodes (13): Product brief, Golden journey, Scope and success, Source reconciliation, Delivery plan and risk register, P0 Plan, P1 De-risk, P2 Data first (+5 more)
...
### Community 3 - "Agent workflow and API contracts"
Cohesion: 0.18
Nodes (12): Data model and calculation rules, Exact calculations, Time and completeness, Mutation transaction, Agent workflow and API contracts, State machine, Tool catalog, Common response envelope (+4 more)

### Community 4 - "Knowledge system maintenance"
Cohesion: 0.24
Nodes (11): EasyLedger agent guide, Mandatory ad-hoc verification passes, Working rules, EasyLedger documentation home, Reading the plan, Knowledge system maintenance, Synchronization contract, Maintainer workflow (+3 more)

### Community 5 - "Implementation handoff and runbook"
Cohesion: 0.20
...
### Community 6 - "Corrections and undo"
Cohesion: 0.31
...
### Community 7 - "Verification and release readiness"
Cohesion: 0.20
...
## Knowledge Gaps
- **58 isolated node(s):** `Working rules`, `Mandatory ad-hoc verification passes`, `Reading the plan`, `Golden journey`, `Scope and success` (+53 more)
  These have ≤1 connection - possible missing edges or undocumented components.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Software requirements specification` connect `Manual access and accessibility` to `Knowledge system maintenance`, `Delivery plan and risk register`, `Authorization and tool safety`, `Corrections and undo`, `Atomic sales and retries`, `Analytics and missing data`, `Verification and release readiness`, `Verification and release readiness`, `System architecture`, `Agent workflow and API contracts`, `Architecture decisions and stack`?**
  _High betweenness centrality (0.355) - this node is a cross-community bridge._
- **Why does `Architecture decisions and stack` connect `Architecture decisions and stack` to `Knowledge system maintenance`, `System architecture`, `Manual access and accessibility`, `Delivery plan and risk register`, `Implementation handoff and runbook`?**
  _High betweenness centrality (0.208) - this node is a cross-community bridge._
- **Why does `Verification and traceability` connect `Verification and release readiness` to `Knowledge system maintenance`, `Delivery plan and risk register`, `Manual access and accessibility`, `Agent workflow and API contracts`, `System architecture`, `Atomic sales and retries`, `Analytics and missing data`, `Corrections and undo`, `Authorization and tool safety`, `Verification and release readiness`, `Implementation handoff and runbook`?**
